...
class RenderEnv(object):
    ...
    def __init__(self, info):
        ...
        self.bg = pygame.image.load('./intermediate/pictures/concatenate2_for_render.png')
        self.bg = pygame.transform.scale(self.bg, (self.bg.get_width() * SCALE, self.bg.get_height() * SCALE))
        self.windows = pygame.display.set_mode((WIDTH * SCALE, HEIGHT * SCALE))
