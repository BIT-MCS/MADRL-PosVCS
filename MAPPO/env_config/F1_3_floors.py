...
'agent_num': 5, #TODO:对于大于2个agent的情况 还需要和代码对接 
'floor_num': 3,
'floor_list': [('site1', 'F1'), ('site1', 'F2'), ('site1', 'F3')],
'top_floor':('site1', 'F1'),
'bottom_floor':('site1', 'F3'),
