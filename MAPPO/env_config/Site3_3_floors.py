...
'action_dim': 25, # 和上边对应
'elevator_action_dim': 3, # 电梯处多的动作，上楼和下楼
'super_action_dim': 1, # 有一些连不到的点，加到最后，使得地图联通
'total_action_dim': 29, # 25 + 3 + 1
'use_global_observation_only': False , #是否喂全局信息，全局喂的时候需要注意智能体间的obs可能很类似
'observation_range': 7, # 观测范围，范围外的全mask掉
'up_down_range': 4, # 半径为3的L1区域内都可以有上下楼的动作
'agent_num': 6, #TODO:对于大于2个agent的情况 还需要和代码对接 
'floor_num': 3,
'floor_list': [('site3', 'F1'), ('site3', 'F2'), ('site3', 'F3')],
'top_floor':('site3', 'F3'),
'bottom_floor':('site3', 'F1'),
...
'uav_init_pos': (('site3', 'F1'), (310, 170)),
'uav_init_pos_2': (('site3', 'F1'), (250, 710)),
