...
def get_config():
    ...
    parser.add_argument("--seed", type=int, default=666, help="Random seed for numpy/torch")
    parser.add_argument("--cuda", action='store_true', default=False, help="by default False, use CPU; or else will use GPU;")
    ...
    parser.add_argument("--use_wandb", type = str, default=False, help = "[for wandb usage], by default True, will log date to wandb server. or else will use tensorboard to log data.")
    ...
    parser.add_argument("--share_policy", action='store_false',
                        default=False, help='Whether agent share the same policy') # 改这个需要注意，因为现在没implement任何一个seperate的function
    ...
    # generate outputs using loaded model, should applied together with model_dir set as true
    parser.add_argument("--generate_outputs", type=bool, default=False, help="by default False. set to True if want to save 1 evaluation")
